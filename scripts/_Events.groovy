...
eventCompileStart = { GantBinding compileBinding ->
    ...
    try {
        def sourceDir = (compileBinding.variables.i18nFieldsPluginDir?.absolutePath ?: basedir) + '/src/groovy'
        def destDir = grailsSettings.projectWorkDir.absolutePath + "/plugin-classes"

        ant.mkdir(dir: destDir)
        grailsConsole.addStatus "Precompiling I18nFields AST transforms."
